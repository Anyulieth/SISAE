...
class AsistClaseCl17 extends conexion
{
	...
	public function AsistClaseCl17_AddAsis($PDtCl17_Fecha,$PTmCl17_Hora,$PStCl17_Estado,$PStCl17_IdMateria,$PStCl17_IdEstudiante)
	{
		$con = new conexion();
		$sql = "CALL PaAsistClaseTb18_GuardarAsistClase('".$PDtCl17_Fecha."','".$PTmCl17_Hora."','".$PStCl17_Estado."',".$PStCl17_IdMateria.",'".$PStCl17_IdEstudiante."');";
		$add = $con->query($sql);
		if($add)
		{
		return $add;
