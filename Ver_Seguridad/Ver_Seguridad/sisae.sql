...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2018 a las 14:02:58
...
if(CONT > 0)
then insert into asistclasetb18(DtAsistClaseTb18_Fecha,TmAsistClaseTb18_Hora,VcAsistClaseTb18_Estado,VcMateriaTb17_IdMateria) VALUES(Fecha,Hora,Estado,IdMat);
select asistclasetb18.VcAsistClaseTb18_IdAsistClase from asistclasetb18 order by VcAsistClaseTb18_IdAsistClase desc limit 1 into id;
insert into asistesttb23(VcEstTb03_IdEstudiante,VcAsistClaseTb18_IdAsistClase)
select esttb03.VcEstTb03_IdEstudiante,asistclasetb18.VcAsistClaseTb18_IdAsistClase from esttb03,asistclasetb18 where esttb03.VcEstTb03_IdEstudiante = IdEst and asistclasetb18.VcAsistClaseTb18_IdAsistClase = id;
else insert into asistclasetb18(DtAsistClaseTb18_Fecha,TmAsistClaseTb18_Hora,VcAsistClaseTb18_Estado,VcMateriaTb17_IdMateria) VALUES(Fecha,Hora,Estado,IdMat);
insert into asistesttb23(VcEstTb03_IdEstudiante,VcAsistClaseTb18_IdAsistClase)
select esttb03.VcEstTb03_IdEstudiante,asistclasetb18.VcAsistClaseTb18_IdAsistClase from esttb03,asistclasetb18 where esttb03.VcEstTb03_IdEstudiante = IdEst;
end if;
end$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistEstTb23_BuscarFecha` (IN `fecha` DATE, IN `idSec` INT, IN `IdMater` INT)  BEGIN
...
set segusuariotb32.VcSegusuarioTb32_Estado = "Activo" where seguridadtb31.InSeguridadTb31_Nivel = 2 and segusuariotb32.VcUsuTb01_Cedula = IdProf;
end$$
...
THEN 
	...
	SeguridadTb31.VcSeguridadTb31_SideNav AS 'SideNav' FROM SeguridadTb31 inner join segusuariotb32 on seguridadtb31.InSeguridadTb31_Id = segusuariotb32.InSeguridadTb31_Id
	WHERE segusuariotb32.VcUsuTb01_Cedula = usu and segusuariotb32.VcSegusuarioTb32_Estado = 'Activo';
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaSegusuarioTb32_Actualizar` (IN `ced` VARCHAR(20), IN `id` INT, IN `Est` VARCHAR(20))  update segusuariotb32 set VcSegusuarioTb32_Estado = Est where VcUsuTb01_Cedula = ced and InSeguridadTb31_Id = id$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaSegusuTb32_Listar_Privilegios` (IN `inicio` INT, IN `final` INT)  select usutb01.VcUsuTb01_Cedula as 'Cedula',usutb01.VcUsuTb01_Nombre as 'Nombre',usutb01.VcUsuTb01_Ape1 as 'Apellido1', usutb01.VcUsuTb01_Ape2 as 'Apellido2', seguridadtb31.InSeguridadTb31_Id as 'Id_Func',GROUP_CONCAT(DISTINCT seguridadtb31.InSeguridadTb31_Nivel) as 'Rol', GROUP_CONCAT(DISTINCT seguridadtb31.VcSeguridadTb31_Detalle SEPARATOR ', ') as 'Detalle' from usutb01 inner join segusuariotb32 on segusuariotb32.VcUsuTb01_Cedula = usutb01.VcUsuTb01_Cedula join seguridadtb31 on seguridadtb31.InSeguridadTb31_Id = segusuariotb32.InSeguridadTb31_Id where segusuariotb32.VcSegusuarioTb32_Estado = 'Activo' group by usutb01.VcUsuTb01_Cedula order by 'date added' limit inicio,final$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaSegusuTb32_Listar_Priv_Admin` (IN `ced` VARCHAR(20))  SELECT seguridadtb31.InSeguridadTb31_Id as 'Id',seguridadtb31.VcSeguridadTb31_Detalle as 'Detalle',segusuariotb32.VcSegusuarioTb32_Estado as 'Estado',seguridadtb31.InSeguridadTb31_Nivel as 'Tipo' from seguridadtb31 inner join segusuariotb32 on seguridadtb31.InSeguridadTb31_Id = segusuariotb32.InSeguridadTb31_Id where segusuariotb32.VcUsuTb01_Cedula = ced$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaSegusuTb32_Listar_Priv_Prof` (IN `ced` VARCHAR(20))  NO SQL
SELECT seguridadtb31.InSeguridadTb31_Id as 'Id',seguridadtb31.VcSeguridadTb31_Detalle as 'Detalle',segusuariotb32.VcSegusuarioTb32_Estado as 'Estado',seguridadtb31.InSeguridadTb31_Nivel as 'Tipo' from seguridadtb31 inner join segusuariotb32 on seguridadtb31.InSeguridadTb31_Id = segusuariotb32.InSeguridadTb31_Id where segusuariotb32.VcUsuTb01_Cedula = ced$$
...
--
-- Volcado de datos para la tabla `admtb02`
--
...
--
-- Volcado de datos para la tabla `asiggradotb12`
--
...
--
-- Volcado de datos para la tabla `asigmateriatb19`
--
...
--
-- Volcado de datos para la tabla `asistclasetb18`
--
...
(2, '2017-11-17', '05:42:44', 'Ausente', 1),
(3, '2017-11-17', '05:42:44', 'Presente', 1),
(4, '2017-11-17', '05:42:44', 'Presente', 1),
(5, '2017-11-17', '05:42:44', 'Presente', 1);
...
--
-- Volcado de datos para la tabla `asistesttb23`
--
...
--
-- Estructura de tabla para la tabla `horariostb29`
--
...
--
-- Volcado de datos para la tabla `horariostb29`
--
...
--
-- Volcado de datos para la tabla `inscmateriatb11`
--
...
--
-- Estructura de tabla para la tabla `matriculatb30`
--
...
--
-- Volcado de datos para la tabla `matriculatb30`
--
...
--
-- Volcado de datos para la tabla `seccionproftb27`
--
...
--
-- Estructura de tabla para la tabla `secesttb28`
--
...
--
-- Volcado de datos para la tabla `secesttb28`
--
...
--
-- Estructura de tabla para la tabla `seguridadtb31`
--
...
--
-- Volcado de datos para la tabla `seguridadtb31`
--

INSERT INTO `seguridadtb31` (`VcSeguridadTb31_Funcion`, `VcSeguridadTb31_Glyphicons`, `VcSeguridadTb31_SideNav`, `InSeguridadTb31_Id`, `InSeguridadTb31_Nivel`, `VcSeguridadTb31_Detalle`) VALUES
('function profesor(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Profesor.php\');}', ' <li><a class=\"glyphicon glyphicon-blackboard\" style=\"margin-top:15px; \" href=\"#\" onclick=\"profesor();\"></a></li>', '<a href=\"#\" onclick=\"profesor();\">Profesores</a>', 2, 1, 'Edicion_Profesores'),
('function seccion(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Seccion-Grupo.php\');}   ', '<li><a class=\"glyphicon glyphicon-sound-7-1\" style=\"margin-top:15px; \" href=\"#\" onclick=\"seccion();\"></a></li>', '<a href=\"#\" onclick=\"seccion();\">Secciones</a>', 4, 1, 'Edicion_Secciones'),
('function encargado(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Encargado.php\');}', '<li><a class=\"glyphicon glyphicon-eye-open\" style=\"margin-top:15px; \" href=\"#\" onclick=\"encargado();\"></a></li>', '<a href=\"#\" onclick=\"encargado();\">Padres</a>', 5, 1, 'Edicion_Encargados'),
('function funcionario(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Funcionario.php\');}', '<li><a class=\"glyphicon glyphicon-user\" style=\"margin-top:15px; \" href=\"#\" onclick=\"funcionario();\"></a></li>', '<a href=\"#\" onclick=\"funcionario();\">Funcionarios</a>', 6, 1, 'Edicion_Funcionarios'),
('function estudiante(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Estudiante.php\');}', '<li><a class=\"glyphicon glyphicon-education\" style=\"margin-top:15px; \" href=\"#\" onclick=\"estudiante();\"></a></li>', '<a href=\"#\" onclick=\"estudiante();\">Estudiantes</a>', 7, 1, 'Edicion_Estudiantes'),
('function materia(){$(\"#contenido\").load(\'Vista/Seg_Nivel/Nivel_1/Materia.php\');}', ' <li><a class=\"glyphicon glyphicon-book\" style=\"margin-top:15px; \" href=\"#\" onclick=\"materia();\"></a></li>', '<a href=\"#\" onclick=\"materia();\">Materias</a>', 8, 1, 'Edicion_Materias'),
('function grado(){\r\n$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_1/Grado.php\');}', '<li><a class=\"glyphicon glyphicon-file\" style=\"margin-top:15px; \" href=\"#\" onclick=\"grado();\"></a></li>', ' <a href=\"#\" onclick=\"grado();\">Grado</a>', 11, 1, 'Edicion_Grados'),
('function bachiller(){\r\n$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_1/Bachiller.php\');}', '<li><a class=\"glyphicon glyphicon-list-alt\" style=\"margin-top:15px; \" href=\"#\" onclick=\"bachiller();\"></a></li>', '<a href=\"#\" onclick=\"bachiller();\">Bachiller</a>', 12, 1, 'Edicion_Bachilleres'),
('function horario(){\r\n$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_1/Horarios.php\');}', '<li><a class=\"glyphicon glyphicon-tasks\" style=\"margin-top:15px; \" href=\"#\" onclick=\"horario();\"></a></li>', '<a href=\"#\" onclick=\"horario();\">Horarios</a>', 13, 1, 'Edicion_Horarios'),
('function Usuario(){\r\n$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_1/Usuario.php\');}', '<li><a class=\"glyphicon glyphicon-wrench\" style=\"margin-top:15px; \"href=\"#\" onclick=\"Usuario();\"></a></li>', '<a href=\"#\" onclick=\"Usuario();\">Usuarios</a>', 14, 1, 'Edicion_Usuarios'),
('function Asistencia(){$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_2/Asistencia.php\');}', '<li><a class=\"glyphicon glyphicon-list-alt\" href=\"#\" style=\"margin-top:15px;\" onclick=\"Asistencia();\"></a></li>', '<a href=\"#\" onclick=\"Asistencia();\">Asistencia</a>', 16, 2, 'Asistencia_Estudiantes'),
('function comunicados(){$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_2/Comunicados.php\');}', '<li><a class=\"glyphicon glyphicon-phone\" href=\"#\" style=\"margin-top:15px;\" onclick=\"comunicados();\"></a></li>', '<a href=\"#\" onclick=\"comunicados();\">Comunicados</a>', 17, 2, 'Comunicados_Padres');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `segusuariotb32`
--

CREATE TABLE `segusuariotb32` (
  `VcUsuTb01_Cedula` varchar(20) CHARACTER SET utf8 NOT NULL,
  `InSeguridadTb31_Id` int(11) NOT NULL,
  `VcSegusuarioTb32_Estado` varchar(20) NOT NULL DEFAULT 'Inactivo'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `segusuariotb32`
--

INSERT INTO `segusuariotb32` (`VcUsuTb01_Cedula`, `InSeguridadTb31_Id`, `VcSegusuarioTb32_Estado`) VALUES
('102220111', 2, 'Inactivo'),
('102220111', 5, 'Activo'),
('102220111', 16, 'Activo'),
('102220111', 14, 'Activo'),
('116000070', 4, 'Activo'),
('116000070', 2, 'Inactivo'),
('504070202', 2, 'Inactivo'),
('504070202', 4, 'Inactivo'),
('504070202', 5, 'Inactivo'),
('504070202', 6, 'Inactivo'),
('504070202', 7, 'Inactivo'),
('504070202', 8, 'Inactivo'),
('504070202', 11, 'Inactivo'),
('504070202', 12, 'Inactivo'),
('504070202', 13, 'Inactivo'),
('504070202', 14, 'Inactivo'),
('504070202', 16, 'Activo'),
('504070202', 17, 'Activo');
...
('102220111', 'Derian', 'Esquivel', 'Venegas', 'Hojancha', 'M', '60918664', 'derian090esq@gmmail.com'),
...
('504070202', 'Derian', 'Esquivel', 'Venegas', 'Hojancha', 'M', '60918664', 'derian090esq@gmail.com');
...
--
-- Indices de la tabla `admtb02`
--
ALTER TABLE `admtb02`
  ADD PRIMARY KEY (`VcAdmTb02_IdAdmin`);

--
-- Indices de la tabla `asiggradotb12`
--
...
--
-- Indices de la tabla `asigmateriatb19`
--
...
--
-- Indices de la tabla `asistclasetb18`
--
...
--
-- Indices de la tabla `asistcoletb08`
--
...
--
-- Indices de la tabla `asistesttb23`
--
...
--
-- Indices de la tabla `estreptb22`
--
...
--
-- Indices de la tabla `funcreptb21`
--
...
--
-- Indices de la tabla `funtb06`
--
ALTER TABLE `funtb06`
  ADD PRIMARY KEY (`VcFunTb06_IdFuncionario`);

--
-- Indices de la tabla `gradoesptb15`
--
...
--
-- Indices de la tabla `graesttb26`
--
...
--
-- Indices de la tabla `horariostb29`
--
ALTER TABLE `horariostb29`
  ADD PRIMARY KEY (`InHorariosTb29_IdHorario`);

--
-- Indices de la tabla `inscmateriatb11`
--
...
--
-- Indices de la tabla `materiatb17`
--
ALTER TABLE `materiatb17`
  ADD PRIMARY KEY (`InMateriaTb17_IdMateria`);

--
-- Indices de la tabla `matriculatb30`
--
...
--
-- Indices de la tabla `profreptb24`
--
...
--
-- Indices de la tabla `seccionproftb27`
--
...
--
-- Indices de la tabla `secgradotb25`
--
...
--
-- Indices de la tabla `seguridadtb31`
--
ALTER TABLE `seguridadtb31`
  ADD PRIMARY KEY (`InSeguridadTb31_Id`);

--
-- Indices de la tabla `segusuariotb32`
--
ALTER TABLE `segusuariotb32`
  ADD KEY `Segusu_Seguridad_Ced` (`VcUsuTb01_Cedula`),
  ADD KEY `Segusu_Seguridad_Id` (`InSeguridadTb31_Id`);

--
-- Indices de la tabla `usutb01`
--
ALTER TABLE `usutb01`
...
--
-- Filtros para la tabla `admtb02`
--
ALTER TABLE `admtb02`
  ADD CONSTRAINT `Admin_Usu` FOREIGN KEY (`VcAdmTb02_IdAdmin`) REFERENCES `usutb01` (`VcUsuTb01_Cedula`);
...
--
-- Filtros para la tabla `segusuariotb32`
--
ALTER TABLE `segusuariotb32`
  ADD CONSTRAINT `Segusu_Seguridad_Ced` FOREIGN KEY (`VcUsuTb01_Cedula`) REFERENCES `usutb01` (`VcUsuTb01_Cedula`),
  ADD CONSTRAINT `Segusu_Seguridad_Id` FOREIGN KEY (`InSeguridadTb31_Id`) REFERENCES `seguridadtb31` (`InSeguridadTb31_Id`);
...
--
-- Metadatos para la tabla admtb02
--

--
-- Metadatos para la tabla asiggradotb12
--

--
-- Metadatos para la tabla asigmateriatb19
--

--
-- Metadatos para la tabla asistclasetb18
--

--
-- Metadatos para la tabla asistcoletb08
--

--
-- Metadatos para la tabla asistesttb23
--

--
-- Metadatos para la tabla bachillertb14
--

--
-- Metadatos para la tabla encreptb09
--

--
-- Metadatos para la tabla enctb05
--

--
-- Metadatos para la tabla especialidadtb16
--

--
-- Metadatos para la tabla estenctb07
--

--
-- Metadatos para la tabla estreptb22
--

--
-- Metadatos para la tabla esttb03
--

--
-- Metadatos para la tabla funcreptb21
--

--
-- Metadatos para la tabla funtb06
--

--
-- Metadatos para la tabla gradoesptb15
--

--
-- Metadatos para la tabla gradotb13
--

--
-- Metadatos para la tabla graesttb26
--

--
-- Metadatos para la tabla horariostb29
--

--
-- Metadatos para la tabla inscmateriatb11
--

--
-- Metadatos para la tabla materiatb17
--

--
-- Metadatos para la tabla matriculatb30
--

--
-- Metadatos para la tabla profreptb24
--

--
-- Metadatos para la tabla proftb04
--

--
-- Metadatos para la tabla reptb10
--

--
-- Metadatos para la tabla seccionproftb27
--

--
-- Metadatos para la tabla secciontb20
--

--
-- Metadatos para la tabla secesttb28
--

--
-- Metadatos para la tabla secgradotb25
--

--
-- Metadatos para la tabla seguridadtb31
--
...
('root', 'sisae', 'seguridadtb31', '[]', '2018-02-21 20:34:44');

--
-- Metadatos para la tabla segusuariotb32
--

--
-- Metadatos para la tabla usutb01
--

--
-- Metadatos para la base de datos sisae
--
COMMIT;
