<?php include "C:/xampp/htdocs/SISAE_APP/Controlador/Estudiante/ListarEst.php";
...
<tr>
  ...
  <td><?php echo $r["Estado"]; ?></td>
    ...
    $('#bor-'+<?php echo $r['Cedula']?>).click(function(e){
      ...
      if(p){$.get('./Controlador/Estudiante/EliminarEst.php','ced='+<?php echo $r['Cedula']?>,function(status){
        $('#tabla').html('');
        CargarTabla();
      });}
    });
