<?php include "C:/xampp/htdocs/SISAE_APP/Controlador/Encargado/ListarEnc.php";
...
<tr>
 ...
 <td style="width:150px;">
    <a data-id="<?php echo $r["Cedula"]; ?>" class="btn btn-edit btn-sm btn-warning">Editar</a>
    <a href="#" id="bor-<?php echo $r["Cedula"]; ?>" class="btn btn-sm btn-danger">Eliminar</a>
    <script>
