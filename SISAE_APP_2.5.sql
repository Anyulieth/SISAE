...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2017 a las 18:03:51
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistClaseTb18_GuardarAsis` (IN `Fecha` DATE, IN `Hora` TIME, IN `Estado` VARCHAR(20), IN `IdMat` VARCHAR(20), IN `IdEst` VARCHAR(20))  begin
DECLARE CONT INT;
DECLARE id INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistEstTb23_BuscarFecha` (IN `fecha` DATE, IN `idsec` INT, IN `idmater` VARCHAR(20))  BEGIN
select usutb01.VcUsuTb01_Cedula as 'Cedula',usutb01.VcUsuTb01_Nombre as 'Nombre',usutb01.VcUsuTb01_Ape1 as 'Apellido1',usutb01.VcUsuTb01_Ape2 as 'Apellido2',asistclasetb18.VcAsistClaseTb18_Estado as 'Estado',asistclasetb18.TmAsistClaseTb18_Hora as 'Hora',asistclasetb18.DtAsistClaseTb18_Fecha as 'Fecha' from usutb01 inner join esttb03 on usutb01.VcUsuTb01_Cedula = esttb03.VcEstTb03_IdEstudiante join asistesttb23 on esttb03.VcEstTb03_IdEstudiante = asistesttb23.VcEstTb03_IdEstudiante join secesttb28 on esttb03.VcEstTb03_IdEstudiante = secesttb28.VcEstTb03_IdEstudiante join asistclasetb18 on asistesttb23.VcAsistClaseTb18_IdAsistClase = asistclasetb18.VcAsistClaseTb18_IdAsistClase where asistclasetb18.VcMateriaTb17_IdMateria = IdMater and secesttb28.InSeccionTb20_IdSeccion = idSec and asistclasetb18.DtAsistClaseTb18_Fecha = fecha order by asistclasetb18.DtAsistClaseTb18_Fecha desc;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistEstTb23_BuscarFechaEst` (IN `fecha` DATE, IN `idEst` VARCHAR(20))  BEGIN
select asistclasetb18.VcAsistClaseTb18_Estado as 'Estado',asistclasetb18.TmAsistClaseTb18_Hora as 'Hora',asistclasetb18.DtAsistClaseTb18_Fecha as 'Fecha',materiatb17.VcMateriaTb17_Nombre as 'Materia' from asistclasetb18 inner join asistesttb23 on asistclasetb18.VcAsistClaseTb18_IdAsistClase = asistesttb23.VcAsistClaseTb18_IdAsistClase join materiatb17 on asistclasetb18.VcMateriaTb17_IdMateria = materiatb17.VcMateriaTb17_IdMateria where asistesttb23.VcEstTb03_IdEstudiante = idEst and asistclasetb18.DtAsistClaseTb18_Fecha = fecha order by asistclasetb18.DtAsistClaseTb18_Fecha desc;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistEstTb23_Listar` (IN `idSec` INT, IN `IdMater` VARCHAR(20))  BEGIN
select usutb01.VcUsuTb01_Cedula as 'Cedula',usutb01.VcUsuTb01_Nombre as 'Nombre',usutb01.VcUsuTb01_Ape1 as 'Apellido1',usutb01.VcUsuTb01_Ape2 as 'Apellido2',asistclasetb18.VcAsistClaseTb18_Estado as 'Estado',asistclasetb18.TmAsistClaseTb18_Hora as 'Hora',asistclasetb18.DtAsistClaseTb18_Fecha as 'Fecha' from usutb01 inner join esttb03 on usutb01.VcUsuTb01_Cedula = esttb03.VcEstTb03_IdEstudiante join asistesttb23 on esttb03.VcEstTb03_IdEstudiante = asistesttb23.VcEstTb03_IdEstudiante join secesttb28 on esttb03.VcEstTb03_IdEstudiante = secesttb28.VcEstTb03_IdEstudiante join asistclasetb18 on asistesttb23.VcAsistClaseTb18_IdAsistClase = asistclasetb18.VcAsistClaseTb18_IdAsistClase where asistclasetb18.VcMateriaTb17_IdMateria = IdMater and secesttb28.InSeccionTb20_IdSeccion = idSec order by asistclasetb18.DtAsistClaseTb18_Fecha desc;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaAsistEstTb23_Listar_Est` (IN `IdEst` VARCHAR(20))  BEGIN
select asistclasetb18.VcAsistClaseTb18_Estado as 'Estado',asistclasetb18.TmAsistClaseTb18_Hora as 'Hora',asistclasetb18.DtAsistClaseTb18_Fecha as 'Fecha',materiatb17.VcMateriaTb17_Nombre as 'Materia' from asistclasetb18 inner join asistesttb23 on asistclasetb18.VcAsistClaseTb18_IdAsistClase = asistesttb23.VcAsistClaseTb18_IdAsistClase join materiatb17 on asistclasetb18.VcMateriaTb17_IdMateria = materiatb17.VcMateriaTb17_IdMateria where asistesttb23.VcEstTb03_IdEstudiante = IdEst;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaEstEncTb07_CargarEst` (IN `idEnc` INT)  BEGIN
select usutb01.VcUsuTb01_Cedula as 'Cedula',usutb01.VcUsuTb01_Nombre as 'Nombre',usutb01.VcUsuTb01_Ape1 as 'Apellido1',usutb01.VcUsuTb01_Ape2 as 'Apellido2' from usutb01 inner join esttb03 on usutb01.VcUsuTb01_Cedula = esttb03.VcEstTb03_IdEstudiante join estenctb07 on esttb03.VcEstTb03_IdEstudiante = estenctb07.VcEstTb03_IdEstudiante where estenctb07.VcEncTb05_IdEncargado = idEnc;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PaEstEncTb07_ListarEstEn` (IN `IdEst` VARCHAR(20))  begin
select usutb01.VcUsuTb01_Cedula as 'Cedula',usutb01.VcUsuTb01_Nombre as 'Nombre',usutb01.VcUsuTb01_Ape1 as 'Apellido1', usutb01.VcUsuTb01_Ape2 as 'Apellido2',esttb03.DtEstTb03_FechaNac as 'Fecha_nac',esttb03.VcEstTb03_Adecuacion as 'Adecuacion',especialidadtb16.VcEspecialidadTb16_Nombre as 'Especialidad' 
from usutb01 inner join esttb03 on usutb01.VcUsuTb01_Cedula = esttb03.VcEstTb03_IdEstudiante join especialidadtb16 on esttb03.VcEspecialidadTb16_IdEspecialidad = especialidadtb16.VcEspecialidadTb16_IdEspecialidad join estenctb07 on esttb03.VcEstTb03_IdEstudiante = estenctb07.VcEstTb03_IdEstudiante where estenctb07.VcEstTb03_IdEstudiante = IdEst;
end$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PaEstTb03_GuardarEst` (IN `IdEst` VARCHAR(20), IN `FecNacEst` DATE, IN `NomEst` VARCHAR(20), IN `Ape1` VARCHAR(20), IN `Ape2` VARCHAR(20), IN `Direccion` VARCHAR(100), IN `Genero` CHAR(1), IN `Telefono` VARCHAR(20), IN `Email` VARCHAR(20), IN `Adecuacion` VARCHAR(20), IN `Id_Especialidad` VARCHAR(20))  begin
	insert into UsuTb01(VcUsuTb01_Cedula, VcUsuTb01_Nombre, VcUsuTb01_Ape1, VcUsuTb01_Ape2, VcUsuTb01_Direccion, CrUsuTb01_Sexo, VcUsuTb01_Telefono, VcUsuTb01_Email)
    values(IdEst, NomEst, Ape1, Ape2, Direccion, Genero, Telefono, Email);
    ...
    values (IdEst, FecNacEst, Adecuacion,'A', Id_Especialidad);
end$$
...
ELSEIF EXISTS(select enctb05.VcEncTb05_IdEncargado,enctb05.VcEncTb05_Clave from enctb05 where VcEncTb05_IdEncargado = user and VcEncTb05_Clave = pass)
then select seguridadtb31.VcSeguridadTb31_Funcion as 'Funcion',seguridadtb31.VcSeguridadTb31_Glyphicons as 'Iconos',seguridadtb31.VcSeguridadTb31_SideNav as 'SideNav' from seguridadtb31 where seguridadtb31.InSeguridadTb31_Nivel = 3;
end if;
END$$
...
CREATE TABLE `asistclasetb18` (
  `VcAsistClaseTb18_IdAsistClase` int(11) NOT NULL,
...
INSERT INTO `asistclasetb18` (`VcAsistClaseTb18_IdAsistClase`, `DtAsistClaseTb18_Fecha`, `TmAsistClaseTb18_Hora`, `VcAsistClaseTb18_Estado`, `VcMateriaTb17_IdMateria`) VALUES
(62, '2017-11-17', '05:42:44', 'Presente', '5'),
(63, '2017-11-17', '05:42:44', 'Presente', '5'),
(64, '2017-11-17', '05:42:44', 'Presente', '5'),
(65, '2017-11-17', '05:42:44', 'Presente', '5'),
(66, '2017-11-17', '05:42:44', 'Presente', '5'),
(67, '2017-11-16', '05:42:44', 'Presente', '5'),
(68, '2017-11-16', '05:42:44', 'Ausente', '5'),
(69, '2017-11-16', '05:42:44', 'Presente', '5'),
(70, '2017-11-16', '05:42:44', 'Presente', '5'),
(71, '2017-11-16', '05:42:44', 'Justificado', '5'),
(72, '2017-11-17', '16:21:36', 'Presente', '5'),
(73, '2017-11-17', '16:21:36', 'Ausente', '5'),
(74, '2017-11-17', '16:21:36', 'Ausente', '5'),
(75, '2017-11-17', '16:21:36', 'Ausente', '5'),
(76, '2017-11-17', '16:21:36', 'Presente', '5'),
(77, '2017-11-17', '16:21:36', 'Presente', '5'),
(78, '2017-11-17', '16:21:36', 'Presente', '5'),
(79, '2017-11-17', '16:21:36', 'Justificado', '5'),
(80, '2017-11-17', '16:21:36', 'Presente', '5'),
(81, '2017-11-17', '16:21:36', 'Presente', '5');
...
INSERT INTO `asistesttb23` (`VcAsistClaseTb18_IdAsistClase`, `VcEstTb03_IdEstudiante`) VALUES
(62, '504070202'),
(63, '808880888'),
(64, '11600007'),
(65, '703740837'),
...
('204560654', '2017-11-07', 'No', 'A', '1234'),
('204750285', '2017-10-04', 'No_Significativa', 'A', 'E04'),
('307540746', '2017-11-13', 'No_Significativa', 'A', 'E04'),
('402830273', '2017-11-21', 'Significativa', 'A', 'E02'),
('504060478', '2017-11-01', 'No_Significativa', 'A', 'E07'),
('504070202', '1995-10-12', 'No', 'A', '1234'),
('603450678', '1995-03-20', 'No_Significativa', 'A', '1234'),
('703740837', '2017-11-14', 'No_Significativa', 'A', 'E08'),
...
('function comunicados(){$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_2/Comunicados.php\');}', '<li><a class=\"glyphicon glyphicon-phone\" href=\"#\" style=\"margin-top:15px;\" onclick=\"comunicados();\"></a></li>', '<a href=\"#\" onclick=\"comunicados();\">Comunicados</a>', 11, 2),
('function principal(){$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_3/Principal.php\');}', '<li><a class=\"glyphicon glyphicon-home\" style=\"margin-top:25px; \" href=\"index.php\"></a></li>', '<a href=\"index.php\">Inicio</a>', 12, 3),
('function encargado(){$(\'#contenido\').load(\'Vista/Seg_Nivel/Nivel_3/Encargado.php\');}', '<li><a class=\"glyphicon glyphicon-user\" style=\"margin-top:15px; \" href=\"#\" onclick=\"encargado();\"></a></li>', '<a href=\"#\" onclick=\"encargado();\">Estudiantes</a>', 13, 3);
...
('204560654', 'Elian', 'Meza', 'Esquivel', 'Hojancha', 'M', '38473625', 'as@as.com'),
('204750285', 'Maureen', 'Sanchez', 'SuÃ±iga', 'nicoya', 'F', '28374656', 'as@as.com'),
('303330333', 'Sonia', 'Venegas', 'Araya', 'Hojancha', 'F', '26598260', 'nada@gmail.com'),
('307540746', 'Fredy', 'Venegas', 'Araya', 'Santa Cruz', 'M', '3847656', 'as@as.com'),
('402370069', 'Fernanda', 'Herrera', 'Villalobos', 'Hojancha', 'F', '62001746', 'nose@gmail.com'),
('402830273', 'Monica', 'Alvarez', 'Montiel', 'Nandayure', 'F', '88887774', 'as@as.com'),
('503840374', 'Esquivel', 'Castro', 'Nicoya', 'M', '2', 'as@as.co', '2017-13-11'),
('504060475', 'Jose', 'Esquivel', 'Castro', 'Nicoya', 'M', '12342345', 'as@as.com'),
('504060478', 'Jose', 'Esquivel', 'Castro', 'Nicoya', 'M', '12342345', 'as@as.com'),
...
('703740837', 'Alberth', 'Blanco', 'Perez', 'Hojancha', 'M', '99887766', 'as@as.com'),
...
ALTER TABLE `secesttb28`
  ADD KEY `Fk_Est_Sec` (`VcEstTb03_IdEstudiante`),
  ADD KEY `Fk_Sec_Est` (`InSeccionTb20_IdSeccion`);
...
--
ALTER TABLE `asistclasetb18`
  MODIFY `VcAsistClaseTb18_IdAsistClase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `seguridadtb31`
  MODIFY `InSeguridadTb31_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `asistesttb23`
  ADD CONSTRAINT `FK_AsCla_Est` FOREIGN KEY (`VcAsistClaseTb18_IdAsistClase`) REFERENCES `asistclasetb18` (`VcAsistClaseTb18_IdAsistClase`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
ALTER TABLE `reptb10`
  ADD CONSTRAINT `FK_AsCla` FOREIGN KEY (`VcAsistClaseTb18_IdAsistClase`) REFERENCES `asistclasetb18` (`VcAsistClaseTb18_IdAsistClase`);
...
--
-- Filtros para la tabla `secesttb28`
--
ALTER TABLE `secesttb28`
  ADD CONSTRAINT `Est_Sec` FOREIGN KEY (`VcEstTb03_IdEstudiante`) REFERENCES `esttb03` (`VcEstTb03_IdEstudiante`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `Sec_Est` FOREIGN KEY (`InSeccionTb20_IdSeccion`) REFERENCES `secciontb20` (`InSeccionTb20_IdSeccion`) ON DELETE NO ACTION ON UPDATE NO ACTION;
