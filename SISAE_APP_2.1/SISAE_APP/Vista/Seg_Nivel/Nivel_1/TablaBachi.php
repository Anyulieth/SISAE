<?php include "C:/xampp/htdocs/SISAE_APP/Controlador/Bachiller/ListarBachi.php";
...
<tr>
  ...
  <td style="width:150px;">
    ...
    $('#bor-'+<?php echo $r['ID']?>).click(function(e){
      ...
      if(p){$.get('Controlador/Bachiller/EliminarBachi.php','id='+<?php echo $r['ID']?>,function(status){
        $('#tabla').html('');
        CargarTabla();
      });}
    });
