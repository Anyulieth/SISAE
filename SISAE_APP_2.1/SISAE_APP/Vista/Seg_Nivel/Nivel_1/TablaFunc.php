<?php include "C:/xampp/htdocs/SISAE_APP/Controlador/Funcionario/ListarFunc.php";
...
<tr>
  ...
  <td style="width:150px;">
    ...
    <script>
      ...
      if(p){$.get('Controlador/Funcionario/EliminarFun.php','ced='+<?php echo $r['Cedula']?>,function(status){
        $('#tabla').html('');
        CargarTabla();
      });}
    });
