...
<body>
<div class="container">
          <h2 class="page-header" style="background-color:#6b6bec;color:white;">Funcionarios</h2>
...
<form role="form" id="agregar" method="post">
  ...
  <div class="form-group">
    ...
    <label>
    <input type="radio" name="estado" value="A"> Activo</label>
    <label>
    <input type="radio" name="estado" value="I"> Inactivo</label>
  </div>
  <div class="form-group">
