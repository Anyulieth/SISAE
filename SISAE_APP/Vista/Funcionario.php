          ...
          <h1 class="page-header" style="background-color:blue;color:white; ">Funcionario</h1>
...
<?php include "C:/xampp/htdocs/SISAE/Controlador/ListarFunc.php";
...
<tr>
  ...
  $("#del-"+<?php echo $r["VcUsuTb01_Cedula"];?>).click(function(){
    ...
    if(p){$.get("C:/xampp/htdocs/SISAE/Controlador/EliminarFuc.php","id="+<?php echo $r["VcUsuTb01_Cedula"];?>);}
  });
</script>
      </td>
</tr>
...
<script>
  ...
  $("#agregar").submit(function(){
    $.post("C:/xampp/htdocs/SISAE/Controlador/AgregarFuc.php");
  });
