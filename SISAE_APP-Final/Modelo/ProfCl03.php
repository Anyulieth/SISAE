...
class ProfCl03 extends UsuCl01 {
	...
	public function ProfCl03_AddProf($PStProfCl03_IdProfesor, $PStCl03_FechaNac, $PStProfCl03_Clave, $PStCl03_Estado, $PStCl01_Nombre, $PStCl01_Apellido1, $PStCl01_Apellido2, $PStCl01_Direccion, $PCrCl01_Sexo, $PStCl01_Telefono, $PStCl01_Email) {
		$con = new conexion();
	...
	public function ProfCl03_ListaProf() {
		$con = new conexion();
		$sql = "CALL PaProfTb04_Listar();";
		$result = $con -> query($sql);
		return $result;
	}
