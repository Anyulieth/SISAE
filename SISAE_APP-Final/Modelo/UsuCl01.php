...
class UsuCl01 extends conexion {
	...
	public function UsuCl01_Lista_Privilegios() {
		$con = new conexion();
		$sql = "CALL PaSegusuTb32_Listar_Privilegios();";
		$result = $con -> query($sql);
		return $result;
	}
	...
	public function UsuCl01_BuscaUsu($ced) {
		$con = new conexion();
		$sql = 'CALL PaUsuTb01_BuscarUsuario(' . $ced . ');';
		$consulta = $con -> query($sql);
		return $consulta;
	}
}
