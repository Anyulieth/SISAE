...
<table class="table table-bordered table-hover" style="font-size:13px;" id="Est">
<thead>
  <th>Cédula</th>
  <th>Nombre</th>
  <th>1° Apellido</th>
...
<tr>
  ...
  <td style="width:160px;"> 
    <a data-id="<?php echo $r["Cedula"]; ?>" class="btn btn-edit btn-sm btn-warning" style="width:60px;margin-top:5px">Editar</a>
    <a href="#" id="bor-<?php echo $r["Cedula"]; ?>" class="btn btn-sm btn-danger" style="width:60px;margin-top:5px">Eliminar</a>
    <a href="#" data-id="<?php echo $r["Cedula"]; ?>" style="width:60px;margin-top:5px" class="btn btn-matri btn-sm btn-success">Matrícula</a>
...
<script src="assets/datatables/js/dataTableEst.js" type="text/javascript"></script>
