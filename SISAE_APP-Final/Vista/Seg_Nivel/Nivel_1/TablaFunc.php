<?php require_once '../../../Modelo/FunCl05.php';
$pagina = $_REQUEST['pagina'];
$por_pagina = 10;
$inicio = ($pagina -1)*$por_pagina;
$fun = new FunCl05();
$result = $fun->FunCl05_ListaFun($inicio,$por_pagina);
$total = $fun->FunCl05_Cantidad();
...
<table class="table table-bordered table-hover" style="font-size:13px;" id="Func">
<thead>
  <th>Cédula</th>
  <th>Nombre</th>
  <th>1° Apellido</th>
...
<tr>
  ...
  animation:false,
          ...
          //ELIMINA
      $.ajax({
      url:'./Controlador/Funcionario/EliminarFun.php',
      type:'GET',
...
<script>
	$(".btn-edit").click(function() {
		id = $(this).data("id");
		$.get("Controlador/Funcionario/Formulario_Editar_Func.php", "ced=" + id, function(data) {
...
<script src="assets/datatables/js/dataTablesFunc.js" type="text/javascript"></script>
