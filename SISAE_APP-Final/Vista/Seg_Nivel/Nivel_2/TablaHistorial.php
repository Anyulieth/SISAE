...
<table class="table table-bordered table-hover" style="font-size:13px;" id="Asis">
<thead>
  <th>Cédula</th>
  <th>Nombre</th>
  <th>1° Apellido</th>
...
<script src="assets/datatables/js/dataTablesAssis.js" type="text/javascript"></script>