...
session_start();
$prof = new ProfCl03();
$result = $prof -> ProfCl03_BuscaProf($_SESSION['usuario']);
?>
<html lang="en">
<head>
</head>
...
foreach ($result as $r) {
	echo $r['Nombre'], ' ', $r['Apellido1'], ' ', $r['Apellido2'];
}
 ?></h2>
...
<select id="mater" name="materia" class="form-control round">
</select>
<label for="seccion">Secciones</label>
<select id="sec" name="seccion" class="form-control round">
</select>
