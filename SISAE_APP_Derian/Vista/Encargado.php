...
<?php include "../Controlador/Encargado/Listar.php";
...
<tr>
 ...
 <td style="width:150px;">
    ...
    if(e){$.get("../Controlador/Encargado/Eliminar.php","id="+<?php echo $r["VcUsuTb01_Cedula"]; ?>
		);}
		});
</script>
      </td>
...
<script>
	...
	$("#agregar").submit(function(e) {
		e.preventDefault();
		$.post("../Controlador/Encargado/Agregar.php",$("#agregar").serialize(),function(status){alert(status)});
  		$('#agregar')[0].reset();
  		$('#newModal').modal('hide');
  		loadTabla();
	});
	...
	$("#buscar").submit(function(e) {
		e.preventDefault();
		$.get("./Controlador/Encargado/Busqueda.php", $("#buscar").serialize(), function(data) {
		$("#tabla").html(data);
		$("#buscar")[0].reset(); });
	});
	...
	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.get("../Controlador/Encargado/Formulario.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
